...
public class ExcelView extends AbstractXlsxView {
	...
	@Override
	public void buildExcelDocument(Map<String, Object> model, Workbook workbook1, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Assert.notEmpty(properties);
		HSSFWorkbook workbook = (HSSFWorkbook) workbook1;
		HSSFSheet sheet;
