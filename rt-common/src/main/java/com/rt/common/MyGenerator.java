...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("/Users/wangmeng/荣智互联/无人机项目");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wrjwlps?characterEncoding=utf8");
        dsc.setUsername("root");
        dsc.setPassword("wangmeng");
...
//        strategy.setNaming(NamingStrategy.removePrefixAndCamel());// 表名生成策略
         strategy.setInclude(new String[] {"tb_ua", "tb_order" }); // 需要生成的表
