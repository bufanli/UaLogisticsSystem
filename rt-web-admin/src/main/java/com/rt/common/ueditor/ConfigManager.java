package com.rt.common.ueditor;

import com.rt.common.ueditor.define.ActionMap;
...
public final class ConfigManager {
	...
	private static final String configFileName = "static/assets/plugins/ueditor/jsp/config.json";
...
//		conf.put("basePath",this.jsonConfig.getString( "basePath" ) );
	...
	private void initEnv () throws FileNotFoundException, IOException {
		...
		try {
			...
			JSONObject jsonConfig = new JSONObject(this.filter(configContent));
